...
//			area = "物流2区";
	...
	public static boolean isInArea(double ALon,double ALat,List maps){
		JSONArray APoints = JSONArray.fromObject(maps);
		int iSum = 0,  
		        iCount;  
	...
	public static boolean isInShangqi(double Alon,double ALat){
		String shangqi =  "[{'lat':30.8950439,'lng':121.8206977},{'lat':30.8818593,'lng':121.8206548},{'lat':30.8818225,'lng':121.8301391},{'lat':30.8950071,'lng':121.8303108}]";
		return isInArea(Alon,ALat,shangqi);
	}
